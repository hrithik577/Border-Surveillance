# ============================================================
# IBVAP - Dashboard (CPU Fallback Mode)
# ============================================================

import os
import sys

# Force CPU mode - bypass CUDA entirely
...
print("=" * 70)
print("🛡️ IBVAP - Dashboard (CPU Mode)")
print("=" * 70)
...
<head>
    <meta charset="UTF-8">
    <title>IBVAP - Smart AI Dashboard</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge.cpu { color: #ffaa00; border: 1px solid #ffaa00; }
        .ask-box {
...
<body>
    <div class="dashboard">
        <div class="header">
            <h1>🛡️ IBVAP <span class="llm-badge">🧠 Powered by Mistral</span></h1>
            <div>
                <span class="badge llm" id="llmStatus">🧠 LLM: Ready</span>
                <span class="badge cpu" id="cpuStatus">🖥️ CPU Mode</span>
    ...
    <script>
        ...
        socket.on('stats_update', function(data) {
            ...
            if (data.mode) {
                document.getElementById('modeInfo').textContent = '🖥️ ' + data.mode;
            }
        ...
        setInterval(function() {
            fetch('/api/llm/status')
                ...
                .then(data => {
                    ...
                    if (data.mode) {
                        document.getElementById('cpuStatus').textContent = '🖥️ ' + data.mode;
                    }
                });
        }, 5000);
    </script>
...
if __name__ == '__main__':
    print("=" * 70)
    print("🛡️ IBVAP - Smart AI Dashboard (CPU Mode)")
    print("=" * 70)
    ...
    print("=" * 70)
    print("Features:")
    print("  ✅ CPU-based YOLO detection")
